        ...
        <div class="row">
          ...
          <div class = "col d-flex justify-content-center">
            <div class="card-detail mt-2">
              <img class="card-img-detail" src="<?php echo $read_produto_view['arquivo'];?>" max-width= "600" max-height="400" alt="">
              <div class="card-body">
                <h3>R$ <?php echo number_format($read_produto_view['valor_produto']);?></h3>
                <h3 class="title mt-3"><?php echo $read_produto_view['nome_produto'];?></h3>
                <p class="text"><?php echo $read_produto_view['descricao_produto'];?></p>
                <a href="meu-carrinho.php?id=<?php echo $id_produto;?>" class="btn btn-primary my-0 py-2" title="Acesse seu Carrinho">
                  <i class="fas fa-shopping-cart"></i>
                  <span id="nav-bar-cart">Add</span>
                </a>
              </div>
            </div>
          </div>
