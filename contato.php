    ...
    <script type="text/javascript" src="js/bootstrap.min.js"></script>   
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="contato.php"><font face="Carter One">Contato</font><span class="sr-only">(Página atual)</span></a>
                </li>  
              </ul>
            </div> 
          </div>
      ...
      <div class="container">
        <section class="pt-4">
          <!--Formulário-->
          <div class="container">     
            <form method="POST" action="functions/contato.php">
              <h1>Contato</h1><br> 
              <div class="form-row">
                <div class="col">
                ...
                <div class="col">
                  <label for=""><font face="Carter One">Sobrenome</font></label>
                  <input type="tel" name="sobrenome" class="form-control" placeholder="Sobrenome" required="required">
                </div>
              </div>
              ...
              <div class="form-group">
                  <label for=""><font face="Carter One">Mensagem</font></label>
                  <textarea required="required" class="form-control" name="mensagem" rows="4"></textarea>
                  <button type="submit" class="btn btn-primary"><font face="Carter One">Enviar</font></button>
              </div> 
            </form>
          </div>
        </section>
